(function () {
  ...
  // absolute URL so this works from both the corporate site and the store
  var ENDPOINT = 'http://diploma.local/wp-json/branded-chatbot/v1/chat';

  // conversation history kept in memory for the current page session
  var history = [];
  ...
  // escape text then turn plain URLs into clickable links
